...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myfiles', '0020_alter_tolovqilganyokiqilmagantype_nomi'),
    ]

    operations = [
        migrations.CreateModel(
            name='TolovQilganYokiQilmaganType_5_10',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tolov_filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myfiles.tolovqilganyokiqilmagantype_5_10')),
            ],
        ),
    ]
