...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myfiles', '0023_tolovqilganyokiqilmagantype_20_25_tolov20_25'),
    ]

    operations = [
        migrations.CreateModel(
            name='TolovQilganYokiQilmaganType_25_30',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tolov_filter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myfiles.tolovqilganyokiqilmagantype_25_30')),
            ],
        ),
    ]
